...
const addDataToDB = (
  db: IDBDatabase,
  data: { imgUrl: string; imgCacheUrl: string },
) => {
...
async function loopNewPaperAndGetImgCache(
  data: INewspaper,
  set: (data: INewspaper) => void,
) {
  // console.log(data)
  let cacheCount = 0;
