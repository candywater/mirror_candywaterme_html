                    ...
                    <div class="resume__content">
                        ...
                        <div class="info-item">
                            ...
                            ><span class="info-text"
                                >770 Marçal de Arruda Campos St., Bauru, SP,
                                Brazil, Zip: 17063-060</span
                            >
                        </div>
                        <div class="info-item">
                            <span class="info-label"
                            ...
                            <div class="resume__content">
                                ...
                                <div class="other">
                                    <div class="other-info">
                                        <p>
                                            PHP & JavaScript developer + Devops
                                            Enthusiast with a decade of success
                                            leading teams in delivering
                                        ...
                                        <p>
                                            ...
                                            methodologies, remote work, cloud
                            ...
                            <div class="resume__content">
                                    ...
                                    <div class="xp-detail">
                                        <ul>
                                            <li>
                                                ...
                                                sites using Laravel, Bootstrap,
                                                Vue, React and WordPress
                                            </li>
                                            <li>
                                                Create scripting language tools
                                            </li>
                                            <li>
                                                Automate dev, builds and deploy
                                                tasks
                                            </li>
                                            <li>
                                                Maintain understanding of
                                                current web technologies or
                                                programming practices through
                                                continuing education, reading
                                                and sharing knowledge
                                            </li>
                                            <li>
                                                Develop databases that support
                                                web applications and web sites
                                            </li>
                                            <li>
                                                Develop and document style
                                ...
                                <div class="xp-item">
                                    <div class="xp-job">
                                        ...
                                        <span
                                            >@ Jurid Publicações Eletrônicas</span
                                        ><br /><small>Bauru, Sao Paulo</small>
                                    </div>
                                    <div class="xp-date">
                                        Aug. 2018 – Apr. 2020
                                    </div>
                                    <div class="xp-detail">
                                        <ul>
                                            <li>
                                                Build or maintain web sites
                                                using native PHP, Python and
                                                JavaScript
                                            </li>
                                            <li>
                                            ...
                                            <li>
                                                Provide backup and maintenance
                                                of GNU/Linux servers
                                            </li>
                                            <li>
                                                Provide documentation for
                                                existent and new applications
                                            </li>
                                        </ul>
                                    </div>
                                </div>
