...
export const COMMENT_LEN_LIMIT_ERROR_MSG =
  "It is too long, please try write less.";
export const WRITE_INFO_ERROR_MSG =
  "At least write your name and comment, plz.";
export const ERROR_MSG = "Something error occurs. Oops.";
